...
const paintCloud = (context, x, y, width, height, col) => {
    ...
    context.bezierCurveTo(x + getXOffset(-40, width), y + getYOffset(50,height), x + getXOffset(-40, width), y + getYOffset(100,height), x + getXOffset(60, width), y + getYOffset(100,height));
    ...
    context.bezierCurveTo(x + getXOffset(250, width), y + getYOffset(100,height), x + getXOffset(250, width), y + getYOffset(70,height), x + getXOffset(220, width), y + getYOffset(50,height));
    context.bezierCurveTo(x + getXOffset(260, width), y + getYOffset(-10,height), x + getXOffset(200, width), y + getYOffset(-20,height), x + getXOffset(170, width), y + getYOffset(0,height));

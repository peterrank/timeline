        ...
        if (this.isDisplayDataDirty()) {
            ...
            for (let res of this.getResourceModel().getAll()) {
                ...
                if (levelOccupiedUntil && levelOccupiedUntil.length > 0) {
                    this.getResourceModel().setHeight(res.getID(), this.inlineResourceHeight+ this.verticalPadding * 2 + levelOccupiedUntil.length * this.barSize);
                } else {
                    this.getResourceModel().setHeight(res.getID(),  this.minimumResourceHeight, this.inlineResourceHeight + this.verticalPadding * 2 + this.barSize);
                }
            }
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                if (res) {
                    let effectiveResourceHeight = this.getResourceModel().getHeight(res.getID()) - 2 * this.verticalPadding - this.inlineResourceHeight;
                    let effectiveRelativeYStart = this.getResourceModel().getRelativeYStart(res.getID()) + this.verticalPadding + this.inlineResourceHeight;
                    let levelOccupiedUntil = resID2levelOccupiedUntil.get(task.getResID());
